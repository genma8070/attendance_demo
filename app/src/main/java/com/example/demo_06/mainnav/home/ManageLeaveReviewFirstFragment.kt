...
class ManageLeaveReviewFirstFragment: BaseFragment<FragmentManageLeaveReviewFirstBinding, PublicViewModel>(
    FragmentManageLeaveReviewFirstBinding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentManageLeaveReviewFirstBinding,
