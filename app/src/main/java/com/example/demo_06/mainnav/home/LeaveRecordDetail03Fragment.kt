...
import com.example.demo_06.databinding.FragmentLeaveRecordDetail03Binding
...
class LeaveRecordDetail03Fragment: BaseFragment<FragmentLeaveRecordDetail03Binding, PublicViewModel>(
    FragmentLeaveRecordDetail03Binding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentLeaveRecordDetail03Binding,
