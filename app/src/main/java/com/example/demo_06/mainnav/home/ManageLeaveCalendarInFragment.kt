...
import com.example.demo_06.databinding.FragmentManageLeaveCalendarInBinding
import com.example.mvvm_learning.setruth.mvvmlearn.viewmodeled.PublicViewModel

class ManageLeaveCalendarInFragment: BaseFragment<FragmentManageLeaveCalendarInBinding, PublicViewModel>(
    FragmentManageLeaveCalendarInBinding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentManageLeaveCalendarInBinding,
