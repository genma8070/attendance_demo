...
class LeaveRecordDetail01Fragment: BaseFragment<FragmentLeaveRecordDetail01Binding, PublicViewModel>(
    FragmentLeaveRecordDetail01Binding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentLeaveRecordDetail01Binding,
