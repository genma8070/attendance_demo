...
import com.example.demo_06.databinding.FragmentManageLeaveReviewSecondBinding
import com.example.mvvm_learning.setruth.mvvmlearn.viewmodeled.PublicViewModel

class ManageLeaveReviewSecondFragment: BaseFragment<FragmentManageLeaveReviewSecondBinding, PublicViewModel>(
    FragmentManageLeaveReviewSecondBinding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentManageLeaveReviewSecondBinding,
