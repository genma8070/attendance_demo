...
class ManageLeaveReviewFirst02Fragment: BaseFragment<FragmentManageLeaveReviewFirst02Binding, PublicViewModel>(
    FragmentManageLeaveReviewFirst02Binding::inflate,
    PublicViewModel::class.java,
    true
){
    override fun initFragment(
        binding: FragmentManageLeaveReviewFirst02Binding,
